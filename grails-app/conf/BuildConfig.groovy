	...
	dependencies {
		...
		compile("org.apache.camel:camel-spring:${camelVersion}",
			...
			excludes 'spring-aop', 'spring-beans', 'spring-core', 'spring-expression', 
                     ...
                     'camel-core', 'junit'/*, 'spring-jms' test won't pass with this*/
		}
        ...
        {
            excludes 'spring-jdbc', 'spring-context-support', 'slf4j-log4j12', 'quartz', 'camel-test-spring', 'camel-core', 'junit'
        }
